    ...
    <div className={`fixed ${positionClasses[position]} z-50 group`}>
      ...
      {showTooltip && (
        <div className="absolute bottom-full mb-4 right-0 bg-white dark:bg-gray-800 text-gray-800 dark:text-white px-4 py-2 rounded-lg shadow-lg border dark:border-gray-700 whitespace-nowrap animate-bounce">
          <div className="text-sm font-medium">{t("Needhelp")}</div>
      ...
      <div className="relative">
        <button
          ...
          className="relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 animate-pulse hover:animate-none"
        ...
        >
          ...
          {/* Glow effect */}
          <div className="absolute inset-0 rounded-full bg-green-400 opacity-0 group-hover:opacity-30 blur-lg transition-opacity duration-300"></div>
        </button>
