...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8 lg:px-10 text-center bg-[rgba(0,0,0,0.5)] rounded-lg shadow-lg py-12">
